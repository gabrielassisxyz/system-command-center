...
- The frontend rebuilds large tables every SSE frame; bind handlers through stable container-level event delegation, not one listener per rendered row/button, or the browser accumulates thousands of DOM listeners between collections.
